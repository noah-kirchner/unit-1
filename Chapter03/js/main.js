...
// Function to fetch and log MegaCities GeoJSON data
function jsAjax(){
    fetch('data/MegaCities.geojson')        // Request GeoJSON file from data folder
        .then(function(response){           // Receive raw server response
            return response.json();         // Convert raw response to usable JSON object
        })
        .then(function(response){           // Receive converted JSON data
            // Data IS available inside the callback
...
// Execute jsAjax once the page has fully loaded
...
// Callback function to display GeoJSON data in the browser
function debugCallback(response){
    // Data IS available here because it is received from debugAjax
